		...
		<div class="col-md-8 ftco-animate">
			<div class="pt-5 mt-5">
				<div class="comment-form-wrap pt-5">
	                ...
	                <form action="<c:url value='/board/write'/>" method="post" class="p-5 bg-light" enctype="multipart/form-data">
	                <input type="hidden" name="user_id" value='${sessionScope.userid}'>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <h5><input type="file" name="uploadFile" class="form-control" id="image"></h5>
	                  </div>
	                  <div class="form-group">
